#ifndef FINDANOTHERCOLORGAME_H
#define FINDANOTHERCOLORGAME_H

#include "../../core/BaseModule.h"

class FindAnotherColorGame : public BaseModule
{
    Q_OBJECT
...
public:
    ...
    explicit FindAnotherColorGame(QObject *parent = nullptr);
