#ifndef CIRCLEHOLDGAMEMODULE_H
#define CIRCLEHOLDGAMEMODULE_H

#include "../../core/BaseModule.h"

class CircleHoldGameModule : public BaseModule
{
    Q_OBJECT
...
public:
    explicit CircleHoldGameModule(QObject *parent = nullptr);
...
private:
    ...
    // Здесь можно добавить поля, связанные с логикой удержания
    // Например:
    // int m_holdTimeRequired;
};
